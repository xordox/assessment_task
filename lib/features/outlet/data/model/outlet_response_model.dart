...
OutletResponseModel outletResponseModelFromJson(String str) =>
    OutletResponseModel.fromJson(json.decode(str));

String outletResponseModelToJson(OutletResponseModel data) =>
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        items: List<OutletItem>.from(
            json["items"].map((x) => OutletItem.fromJson(x))),
        total: json["total"],
      );
